...
GRANT ALL PRIVILEGES ON loader_user.MoviesAndShows TO ADMIN_ROLE;
GRANT ALL PRIVILEGES ON loader_user.Genres TO ADMIN_ROLE;
GRANT ALL PRIVILEGES ON loader_user.Directors TO ADMIN_ROLE;
GRANT ALL PRIVILEGES ON loader_user.Countries TO ADMIN_ROLE;
GRANT ALL PRIVILEGES ON loader_user.Cast TO ADMIN_ROLE;
GRANT ALL PRIVILEGES ON loader_user.MoviesGenres TO ADMIN_ROLE;
GRANT ALL PRIVILEGES ON loader_user.MoviesDirectors TO ADMIN_ROLE;
GRANT ALL PRIVILEGES ON loader_user.MoviesCast TO ADMIN_ROLE;
GRANT ALL PRIVILEGES ON loader_user.MoviesCountries TO ADMIN_ROLE;

-- Le manager peut gérer les films et leurs relations (insert, update, select)
GRANT CREATE SESSION TO MANAGER_ROLE;
GRANT INSERT, UPDATE, SELECT ON loader_user.MoviesAndShows TO MANAGER_ROLE;
...
GRANT CREATE SESSION TO REGULAR_ROLE;
GRANT SELECT ON loader_user.MoviesAndShows TO REGULAR_ROLE;
